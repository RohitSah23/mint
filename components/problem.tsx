      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col gap-16 relative z-10">
        ...
        >
          {problems.map((p, idx) => (
            <div
              key={idx}
              className="relative bg-white/10 backdrop-blur-lg shadow-xl rounded-2xl p-6 flex flex-col gap-4 hover:scale-105 transform transition-transform duration-500 border border-indigo-400/30"
            >
              {/* Icon & Title */}
              <div className="flex items-center gap-4">
                ...
                <h3 className="bg-gradient-to-r from-indigo-400 via-purple-400 to-blue-500 bg-clip-text text-transparent font-semibold text-xl">{p.title}</h3>
              </div>
