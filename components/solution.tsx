      ...
      <div className="max-w-7xl mx-auto px-6  relative z-10 flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-12">
          {steps.map((step) => (
            ...
            >
              {/* Number */}
              <div className="flex-shrink-0 flex items-center justify-center w-16 h-16 rounded-full bg-white/10 text-white text-2xl font-bold border-2  border-indigo-400/30 hover:scale-105 transition-transform">
                {step.number}
              </div>

              {/* Card */}
              <div className="flex-1 bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border  border-indigo-400/30 hover:scale-105  transition-transform duration-300">
